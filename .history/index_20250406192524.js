...
app.post('/api/chat', tempUpload.single('image'), async (req, res) => {
    try {
        ...
        let instruction = "Odpowiadaj zawsze w języku polskim, bez względu na język zapytania. Twoje odpowiedzi powinny być pomocne, dokładne i przyjazne oraz dopracowane.";
